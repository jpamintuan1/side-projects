...
(function(){
    ...
    function gameLoop(userInput) {
        ...
        switch(state){
            case "create-class":
                getCharacterClass(userInput);
                break;
            case "create-name":
                getCharacterName(userInput);
                break;
            case "story-start":
                startGame();
                break;
            case "story-fight":
                ...
                break;
            case "story-continue":
                storyContinue(userInput);
                break;
        }
    }
    function getCharacterClass(userInput){
    ...
    function getCharacterName(userInput){
        state = "story-start";
    ...
    function storyContinue(userInput){
